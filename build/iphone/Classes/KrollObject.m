 ...
 * Copyright (c) 2009-2011 by LessiusServicesScreencast, Inc. All Rights Reserved.
...
//@interface LessiusServicesScreencastObject : NSObject
//@end

@interface LessiusServicesScreencastObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LessiusServicesScreencastObject class]])
		{
			for (NSString *key in [[(LessiusServicesScreencastObject*)o modules] allKeys])
			{
