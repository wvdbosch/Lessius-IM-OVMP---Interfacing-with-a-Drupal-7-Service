...
@interface LessiusServicesScreencastObject : KrollCoverageObject {
#else
@interface LessiusServicesScreencastObject : KrollObject {
#endif
@private
...
extern NSString * LessiusServicesScreencast$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	LessiusServicesScreencastObject *_lessiusservicesscreencast;
	BOOL shutdown;
