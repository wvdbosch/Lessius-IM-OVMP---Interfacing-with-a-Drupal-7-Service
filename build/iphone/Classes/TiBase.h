...
// in simulator we redefine to format for LessiusServicesScreencast Developer console
...
{\
	NSString * exceptionName = [@"org.lessiusservicesscreencast." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lessiusservicesscreencast";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UILessiusServicesScreencastNativeItemNone = -1, 
	UILessiusServicesScreencastNativeItemSpinner = -2,
	UILessiusServicesScreencastNativeItemProgressBar = -3,
	
	UILessiusServicesScreencastNativeItemSlider = -4,
	UILessiusServicesScreencastNativeItemSwitch = -5,
	UILessiusServicesScreencastNativeItemMultiButton = -6,
	UILessiusServicesScreencastNativeItemSegmented = -7,
	
	UILessiusServicesScreencastNativeItemTextView = -8,
	UILessiusServicesScreencastNativeItemTextField = -9,
	UILessiusServicesScreencastNativeItemSearchBar = -10,
	
	UILessiusServicesScreencastNativeItemPicker = -11,
	UILessiusServicesScreencastNativeItemDatePicker = -12,
	
	UILessiusServicesScreencastNativeItemInfoLight = -13,
	UILessiusServicesScreencastNativeItemInfoDark = -14,
	
	UILessiusServicesScreencastNativeItemDisclosure = -15,
	
	UILessiusServicesScreencastNativeItemContactAdd = -16
};
